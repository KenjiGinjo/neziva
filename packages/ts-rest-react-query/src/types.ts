...
import type { InitClientReturn } from './react-query'
...
export type ErrorResponse<TAppRoute extends AppRoute> = ClientInferResponses<TAppRoute, ErrorHttpStatusCode, 'ignore'>

export type UseQueryOptions<TAppRoute extends AppRoute> = TanStackUseQueryOptions<
  DataResponse<TAppRoute>,
  ErrorResponse<TAppRoute>
> & {
  hookRequested?: (data: DataResponse<TAppRoute>) => void | Promise<void>
}
...
type InferClientArgs<TClient extends InitClientReturn<any, any>> =
  TClient extends InitClientReturn<any, infer TClientArgs> ? TClientArgs : never
