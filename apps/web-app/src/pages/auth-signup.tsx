import { vAuthRegisterByEmail } from '@haole/validations'
...
export function PageAuthSignup() {
  const { form, dto, patch } = useSchemaPatch(vAuthRegisterByEmail)
      ...
      <div className="min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/10 to-secondary/10 items-center justify-center p-12">
          <div className="max-w-md">
            <h1 className="text-4xl font-bold mb-4 text-foreground">Get Started</h1>
          ...
          <Card className="w-full max-w-md p-8">
            ...
            <Form.Form form={form} onChange={patch}>
              ...
              <Form.Input
                ...
                desc="Must be at least 6 characters"
              />
              ...
              <Form.Submit
                form={form}
                request={() => $qc.auth.register.$post.mutation({ body: dto })}
                onSuccess={async (res) => {
